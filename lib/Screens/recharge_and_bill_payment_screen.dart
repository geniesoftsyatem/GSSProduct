...
class _RechargeAndBillPaymentState extends State<RechargeAndBillPayment> {
  ...
  void initState() {
    ...
    homepageList = [
      HomePageList(
          id: "7", name: "Mobile Payment", image: "images/mobile_prepaid.png"),
      /*HomePageList(
          id: "8", name: "Mobile Postpaid", image: "images/mobile_prepaid.png"),*/
      HomePageList(
          id: "9", name: "Landline Bill", image: "images/landline_postpaid.png"),
      HomePageList(
          id: "10", name: "Electricity Bill", image: "images/electricity.png"),
      HomePageList(
          id: "11", name: "GAS", image: "images/gas.png"),
      HomePageList(
          id: "12", name: "Water Tax Bill", image: "images/water.png"),
      HomePageList(
          id: "13", name: "LIC", image: "images/lic_payment.png"),
      HomePageList(
          id: "14", name: "Fast Tag", image: "images/fasttag_gm.png"),
      HomePageList(
          id: "15", name: "DTH Recharge", image: "images/dth.png"),
      /*HomePageList(
          id: "16", name: "BroadBand Prepaid", image: "images/boardband_prepaid.png"),*/
      HomePageList(
          id: "17", name: "Broad-Band", image: "images/boardband_prepaid.png"),
    ...
    if(type=="Customer"){
      homepageList = [
        ...
        HomePageList(
            id: "12", name: "Water Tax Bill", image: "images/water.png"),
        HomePageList(
            id: "13", name: "Property Tax", image: "images/propertytax_gm.png"),
        HomePageList(
            id: "13", name: "Insurance Premium", image: "images/insurancepremium_gm.png"),
        HomePageList(
            id: "14", name: "Fast Tag", image: "images/fasttag_gm.png"),
        HomePageList(
            id: "15", name: "DTH Recharge", image: "images/dth.png"),
      ...
      homepageList = [
        ...
        HomePageList(
            id: "12", name: "Water Tax Bill", image: "images/water.png"),
        HomePageList(
            id: "13", name: "LIC Premium", image: "images/lic_payment.png"),
        HomePageList(
            id: "14", name: "Fast Tag", image: "images/fasttag_gm.png"),
        HomePageList(
            id: "15", name: "DTH Recharge", image: "images/dth.png"),
...
class _MobileRechargeState extends State<MobileRecharge> {
  ...
  void initState() {
    if(widget.option=="Mobile Payment"){
      homepageList = [
        HomePageList(
            id: "1", name: "Prepaid", image: "images/mobile_prepaid.png"),
        HomePageList(
            id: "2", name: "Postpaid", image: "images/mobile_prepaid.png"),

      ];
    }else if(widget.option=="GAS"){
      homepageList =[
        HomePageList(
            id: "3", name: "Piped Gas Bill", image: "images/gaspipeline_gm.png"),
        HomePageList(
            id: "7", name: "Gas Cylinder Booking", image: "images/gascylender_gm.png"),

      ];
    }else if(widget.option=="Broad-Band"){
      homepageList =[
        HomePageList(
          id: "8", name: "BroadBand Prepaid", image: "images/boardband_prepaid.png"),
        HomePageList(
          id: "9", name: "BroadBand Postpaid", image: "images/boardband_prepaid.png")
      ];
    }
