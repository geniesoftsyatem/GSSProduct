  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: type == "Customer" ? AppBar(
        ...
        backgroundColor: const Color(0xFF3A3A3A),
        title: type == null ? Text("") : Text("Genie Money - " + type, style: const TextStyle(color: Color(0xFFFFAE00)),),
        actions: <Widget> [
          Padding(
            padding: const EdgeInsets.only(right: 20.0),
            child: GestureDetector(
                          ...
                          onTap: () {
                            if (e.name == "Portfolio") {
                              ...
                              ZoomDrawer.of(context)!.isOpen()
                                  ...
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => SalesPartnerScreen(e.name)));
