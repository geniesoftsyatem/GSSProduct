                      ...
                      child: RichText(
                        text: TextSpan(
                          children: [
                            const TextSpan(
                              text:
                                  "We have updated out T&C for Genie Money Credit Score Services, By continuing your use of Genie Money account, you agree with the updated ",
                              style: TextStyle(
                                  color: Color(0xFFFFAE00), fontSize: 12.0),
                            ),
                            TextSpan(
                                text:
                                    "Terms of Service - Genie Money Credit Score.",
